...
class PpeStudentAssignmentController extends Controller
{
    /**
    ...
    public function index(Request $request): View
    {
        ...
        // Get the currently assigned PPE lecturer (check if all students have same lecturer)
        $currentLecturer = $this->getCurrentPpeLecturer();
        ...
        return view('academic.ppe.assign-students.index', compact(
            'students',
            'lecturers',
            'groups',
            'stats',
    ...
    /**
     * Get the current PPE lecturer assigned to students.
     * Returns the lecturer if all students have the same one, null otherwise.
     */
    private function getCurrentPpeLecturer(): ?User
    {
    ...
    /**
     * Assign a single lecturer to ALL students (PPE module specific).
     */
    ...
    public function export(Request $request)
    {
        ...
        $headers = [
            ...
            'Content-Disposition' => 'attachment; filename="ppe-student-assignments.csv"',
        ];
