...
class OshLogbookController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $logbookAssessment = \App\Models\Assessment::forCourse('OSH')
        ...
        $allEvaluations = OshLogbookEvaluation::whereIn('student_id', $students->pluck('id'))
            ->get()
            ->groupBy('student_id');
        ...
        return view('academic.osh.logbook.index', compact(
            'studentsWithStatus',
            'groups'
        ));
    }
    ...
    public function show(Student $student): View
    {
        ...
        if (!$logbookAssessment) {
            abort(404, 'Logbook assessment not found. Please create a Logbook assessment for Occupational Safety & Health.');
        }
        ...
        $evaluations = OshLogbookEvaluation::forStudent($student->id)
            ->get()
            ->keyBy('month');
        ...
        return view('academic.osh.logbook.show', compact(
            'student',
            'periods',
            'totalScore',
            'completedPeriods',
    ...
    public function store(Request $request, Student $student): RedirectResponse
    {
        ...
        foreach ($validPeriodIndices as $periodIndex) {
            ...
            if ($score !== null) {
                OshLogbookEvaluation::updateOrCreate(
                    [
        ...
        return redirect()->route('academic.osh.logbook.show', $student)
