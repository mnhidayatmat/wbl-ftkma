...
class IpProgressController extends Controller
{
    /**
    ...
    public function index(Request $request): View
    {
        ...
        // Get active lecturer assessments
        $lecturerAssessments = Assessment::forCourse('IP')
            ->forEvaluator('lecturer')
            ->active()
            ->get();

        // Get active IC assessments (all types - marks are stored in StudentAssessmentMark)
        ...
        // Get all IC marks (now using StudentAssessmentMark, not rubric marks)
        ...
        return view('academic.ip.progress.index', compact(
            'totalStudents',
            'lecturerCompleted',
            'icCompleted',
            'lecturerProgress',
