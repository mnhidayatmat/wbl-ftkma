...
use App\Models\IP\IpModerationRecord;
...
class IpModerationController extends Controller
{
    /**
    ...
    public function index(Request $request): View
    {
        ...
        $moderationRecords = IpModerationRecord::whereIn('student_id', $students->pluck('id'))
        ...
        return view('academic.ip.moderation.index', compact(
            'studentsWithScores',
            'groups'
        ));
    }
    ...
    public function show(Student $student): View
    {
        ...
        $moderation = IpModerationRecord::where('student_id', $student->id)->first();

        return view('academic.ip.moderation.show', compact(
            'student',
            'lecturerTotal',
            'icTotal',
            'finalScore',
    ...
    public function store(Request $request, Student $student)
    {
        ...
        $moderation = IpModerationRecord::updateOrCreate(
        ...
        return redirect()->route('academic.ip.moderation.index')
