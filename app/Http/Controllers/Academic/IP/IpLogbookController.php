...
class IpLogbookController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $logbookAssessment = \App\Models\Assessment::forCourse('IP')
        ...
        $allEvaluations = IpLogbookEvaluation::whereIn('student_id', $students->pluck('id'))
            ->get()
            ->groupBy('student_id');
        ...
        return view('academic.ip.logbook.index', compact(
            'studentsWithStatus',
            'groups'
        ));
    }
    ...
    public function show(Student $student): View
    {
        ...
        if (! $logbookAssessment) {
            abort(404, 'Logbook assessment not found. Please create a Logbook assessment for Integrated Project.');
        }
        ...
        $evaluations = IpLogbookEvaluation::forStudent($student->id)
            ->get()
            ->keyBy('month');
        ...
        return view('academic.ip.logbook.show', compact(
            'student',
            'periods',
            'totalScore',
            'completedPeriods',
    ...
    public function store(Request $request, Student $student): RedirectResponse
    {
        ...
        foreach ($validPeriodIndices as $periodIndex) {
            ...
            if ($score !== null) {
                IpLogbookEvaluation::updateOrCreate(
                    [
        ...
        return redirect()->route('academic.ip.logbook.show', $student)
