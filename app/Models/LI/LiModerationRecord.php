...
class LiModerationRecord extends Model
{
    use HasFactory;

    protected $fillable = [
        'student_id',
        'original_supervisor_score',
        'original_ic_score',
        'original_final_score',
        'adjusted_supervisor_score',
        'adjusted_ic_score',
    ...
    protected $casts = [
        'original_supervisor_score' => 'decimal:2',
        'original_ic_score' => 'decimal:2',
        'original_final_score' => 'decimal:2',
        'adjusted_supervisor_score' => 'decimal:2',
