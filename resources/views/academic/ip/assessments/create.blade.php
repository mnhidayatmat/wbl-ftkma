...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Update weight display when CLO weight changes
    const observer = new MutationObserver(function(mutations) {
        updateWeightDisplay();
    });
    const totalCloWeightElement = document.getElementById('totalCloWeight');
    if (totalCloWeightElement) {
        observer.observe(totalCloWeightElement, { childList: true, characterData: true, subtree: true });
    }
