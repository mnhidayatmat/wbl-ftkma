...
@section('title', 'IP – Academic Tutor Evaluation')
...
<div class="py-4 sm:py-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-4 sm:mb-6">
            <h1 class="text-xl sm:text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">IP – Academic Tutor Evaluation</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
            <form method="GET" action="{{ route('academic.ip.at.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <!-- Search -->
                <div>
                ...
                <div class="flex items-end space-x-2 sm:col-span-2 lg:col-span-1">
                    ...
                    <a href="{{ route('academic.ip.at.index') }}" 
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    @can('edit-at-marks', $student)
                                        <a href="{{ route('academic.ip.at.show', $student) }}" 
