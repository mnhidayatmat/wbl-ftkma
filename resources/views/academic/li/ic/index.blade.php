...
@section('title', 'Industrial Training – Industry Coach Evaluation')
...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">Industrial Training – Industry Coach Evaluation</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-2">Enter assessment marks for assigned students</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 mb-6">
            <form method="GET" action="{{ route('academic.li.ic.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <!-- Search -->
                <div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-[#003A6C]">
                            <tr>
                                ...
                                <th class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Total Marks</th>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                                    ...
                                    @elseif($student->evaluation_status == 'in_progress')
                                        <span class="px-1.5 sm:px-2 py-0.5 sm:py-1 text-xs font-semibold rounded-full bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-300">
                                            Progress ({{ $student->completed_assessments }}/{{ $student->total_assessments }})
                                        </span>
                                    @else
                                ...
                                <td class="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                                    <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <span class="text-gray-500">/{{ number_format($totalWeight ?? 100, 0) }}%</span>
                                    </div>
                                </td>
