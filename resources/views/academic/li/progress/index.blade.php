...
@section('title', 'Industrial Training - Evaluation Progress')
...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">Industrial Training - Evaluation Progress</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <div class="flex items-center justify-between mb-2">
                    <div class="text-sm font-medium text-gray-600 dark:text-gray-400">Supervisor Completed</div>
                    <div class="text-lg font-bold text-[#0084C5]">{{ $supervisorCompleted }}</div>
                </div>
                <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                    <div class="bg-[#0084C5] h-3 rounded-full transition-all" style="width: {{ min($supervisorProgress, 100) }}%"></div>
                </div>
                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ number_format($supervisorProgress, 1) }}%</div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div class="space-y-1">
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-semibold text-yellow-600 dark:text-yellow-400">{{ $pendingSupervisor }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-[#003A6C]">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Supervisor Completed</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Supervisor Progress</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">
                                {{ $stat['supervisor_completed'] }} / {{ $stat['total'] }}
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-24 bg-gray-200 dark:bg-gray-600 rounded-full h-2 mr-2">
                                        <div class="bg-[#0084C5] h-2 rounded-full" style="width: {{ min($stat['supervisor_progress'], 100) }}%"></div>
                                    </div>
                                    <span class="text-sm text-gray-600 dark:text-gray-300">{{ number_format($stat['supervisor_progress'], 1) }}%</span>
                                </div>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">
