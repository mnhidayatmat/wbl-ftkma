                            ...
                            @forelse($assessments as $assessmentName => $assessmentGroup)
                                ...
                                <tr class="bg-gray-50 dark:bg-gray-800/50 border-l-4 border-[#0084C5]">
                                    <td class="px-4 sm:px-6 lg:px-8 py-4" colspan="7">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <a href="{{ route('academic.li.assessments.rubric-report.show', $firstAssessment) }}"
                                                ...
                                                <a href="{{ route('academic.li.assessments.edit', $firstAssessment) }}"
                                                ...
                                                <form action="{{ route('academic.li.assessments.destroy', $firstAssessment) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this assessment and all its CLOs? This action cannot be undone.')">
                                            @csrf
                                            @method('DELETE')
                                ...
                                @foreach($allClos as $clo)
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                        ...
                                        <td class="px-4 sm:px-6 lg:px-8 py-3.5">
                                            <div class="flex items-center gap-1.5">
                                                <form action="{{ route('academic.li.assessments.toggle-active', $clo->assessment_id) }}" method="POST" class="inline">
                                                    @csrf
                                                    <button type="submit" 
                                                ...
                                                <a href="{{ route('academic.li.assessments.edit', $clo->assessment_id) }}" 
