...
@section('title', 'Industrial Training - Reports')
...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">Industrial Training - Reports</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">All students in Industrial Training</p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <a href="{{ route('academic.li.reports.cohort', ['format' => 'excel']) }}"
                    ...
                    <a href="{{ route('academic.li.reports.cohort', ['format' => 'pdf']) }}"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div class="space-y-3 max-h-64 overflow-y-auto">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('academic.li.reports.group', ['group' => $group->id, 'format' => 'excel']) }}"
                               class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded transition-colors">
                                Excel
                            </a>
                            <a href="{{ route('academic.li.reports.group', ['group' => $group->id, 'format' => 'pdf']) }}"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div class="space-y-3 max-h-64 overflow-y-auto">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('academic.li.reports.company', ['company' => $company->id, 'format' => 'excel']) }}"
                               class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded transition-colors">
                                Excel
                            </a>
                            <a href="{{ route('academic.li.reports.company', ['company' => $company->id, 'format' => 'pdf']) }}"
                               class="px-3 py-1 bg-red-600 hover:bg-red-700 text-white text-xs font-semibold rounded transition-colors">
                                PDF
                            </a>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Supervisor Contribution Report</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Supervisor contribution breakdown</p>
                    </div>
                </div>
