...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">LI Assessment Schedule</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-5">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Supervisor Evaluation (40%)</h3>
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                Applies to: <strong>{{ $supervisorWindow->selected_assessments_display }}</strong>
                            </p>
                        </div>
                    ...
                    <form method="POST" action="{{ route('academic.li.schedule.update-window') }}" class="space-y-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <label for="supervisor_enabled" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                Enable Supervisor Evaluation
                            </label>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes"
                                      rows="2"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#0084C5] focus:border-[#0084C5] dark:bg-gray-700 dark:text-white">{{ $supervisorWindow->notes }}</textarea>
                        </div>
