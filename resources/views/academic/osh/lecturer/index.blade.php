...
@section('title', 'OSH – Lecturer Evaluation')
...
<div class="py-4 sm:py-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-4 sm:mb-6">
            <h1 class="text-xl sm:text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">OSH – Lecturer Evaluation</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
            <form method="GET" action="{{ route('academic.osh.lecturer.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <!-- Search -->
                <div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    @can('edit-at-marks', $student)
                                        <a href="{{ route('academic.osh.lecturer.show', $student) }}" 
                                    ...
                                    <div class="flex flex-col items-center">
                                        ...
                                        @if(auth()->user()->isLecturer() && !auth()->user()->isAdmin())
                                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                                Please contact an administrator to assign students to you as Lecturer.
                                            </p>
                                        @endif
                                    </div>
                                </td>
