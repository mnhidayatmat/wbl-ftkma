...
@section('title', 'OSH - Assign Students')
...
<div class="py-4 sm:py-6">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">OSH Student Assignment</h1>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-2">Assign a single Lecturer to all Occupational Safety & Health students</p>
            </div>
            <a href="{{ route('academic.osh.assign-students.export') }}"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-6">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white">OSH Lecturer Assignment</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Assign a single lecturer to supervise all OSH students</p>
                </div>
            </div>
            ...
            <div class="mb-6 p-4 rounded-lg {{ $currentLecturer ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : 'bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800' }}">
                <div class="flex items-center justify-between">
                    ...
                    @if($currentLecturer)
                        <form action="{{ route('academic.osh.assign-students.clear-lecturer') }}" method="POST" class="inline"
            ...
            <form action="{{ route('academic.osh.assign-students.assign-lecturer') }}" method="POST" class="flex flex-col sm:flex-row gap-4">
                @csrf
                <div class="flex-1">
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-700 dark:text-blue-400 mt-1">
                        For OSH module, Industry Coaches are assigned by students during their registration process.
                        The IC assignment shown below is set by each student when they register for Occupational Safety & Health.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 mb-6">
            <form method="GET" action="{{ route('academic.osh.assign-students.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                <!-- Search -->
                <div>
