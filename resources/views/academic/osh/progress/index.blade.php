...
@section('title', 'OSH Evaluation Progress')
...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">OSH Evaluation Progress</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ $pendingLecturer }}</div>
            </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-[#003A6C]">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Lecturer Completed</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Lecturer Progress</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">
                                {{ $stat['lecturer_completed'] }} / {{ $stat['total'] }}
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-24 bg-gray-200 dark:bg-gray-600 rounded-full h-2 mr-2">
                                        <div class="bg-[#0084C5] h-2 rounded-full" style="width: {{ min($stat['lecturer_progress'], 100) }}%"></div>
                                    </div>
                                    <span class="text-sm text-gray-600 dark:text-gray-300">{{ number_format($stat['lecturer_progress'], 1) }}%</span>
                                </div>
                            </td>
                        </tr>
                        @empty
