...
@section('title', 'OSH Result Finalisation')
...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">OSH Result Finalisation</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 mb-6">
            <form method="GET" action="{{ route('academic.osh.finalisation.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <!-- Search -->
                <div>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                                @if(!$finalisation || !$finalisation->is_finalised)
                                    <form action="{{ route('academic.osh.finalisation.student', $student) }}" 
                                          method="POST" 
                                          class="inline"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-5">
                    ...
                    <form action="{{ route('academic.osh.finalisation.group') }}" 
                          method="POST"
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-5">
                    ...
                    <form action="{{ route('academic.osh.finalisation.course') }}" 
                          method="POST"
                          onsubmit="return confirm('⚠️ WARNING: This will finalise results for ALL students in the OSH course. This action cannot be undone. Are you absolutely sure?');">
                        @csrf
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Notes (Optional)</label>
                            <textarea name="notes" 
