...
@section('title', 'PPE Assessment Schedule')
            ...
            <div class="bg-gradient-to-r from-[#003A6C] to-[#0084C5] rounded-2xl p-6 md:p-8">
                <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl md:text-3xl font-bold text-white">PPE Assessment Schedule</h1>
                ...
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white">Lecturer Evaluation</h3>
                    ...
                    @if($lecturerWindow->start_at && $lecturerWindow->end_at)
                    <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span>{{ $lecturerWindow->start_at->format('M d, Y') }} - {{ $lecturerWindow->end_at->format('M d, Y') }}</span>
                    </div>
                    @else
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/10 dark:to-gray-800 rounded-xl border border-purple-100 dark:border-purple-800/30 p-6">
                        <div class="flex items-center gap-3 mb-5">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Lecturer Evaluation</h3>
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ $lecturerWindow->selected_assessments_display }}</p>
                            </div>
                        </div>

                        <form method="POST" action="{{ route('academic.ppe.schedule.update-window') }}" class="space-y-4">
                            @csrf
                            ...
                            <div>
                                ...
                                <textarea name="notes"
                                          ...
                                          class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:text-white text-sm">{{ $lecturerWindow->notes }}</textarea>
                            </div>
