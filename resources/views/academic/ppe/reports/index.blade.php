...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">PPE Reports</h1>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">All students in PPE course</p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <a href="{{ route('academic.ppe.reports.cohort', ['format' => 'excel']) }}" 
                    ...
                    <a href="{{ route('academic.ppe.reports.cohort', ['format' => 'pdf']) }}" 
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div class="space-y-3 max-h-64 overflow-y-auto">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('academic.ppe.reports.group', ['group' => $group->id, 'format' => 'excel']) }}" 
                               class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded transition-colors">
                                Excel
                            </a>
                            <a href="{{ route('academic.ppe.reports.group', ['group' => $group->id, 'format' => 'pdf']) }}" 
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div class="space-y-3 max-h-64 overflow-y-auto">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('academic.ppe.reports.company', ['company' => $company->id, 'format' => 'excel']) }}" 
                               class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded transition-colors">
                                Excel
                            </a>
                            <a href="{{ route('academic.ppe.reports.company', ['company' => $company->id, 'format' => 'pdf']) }}" 
                               class="px-3 py-1 bg-red-600 hover:bg-red-700 text-white text-xs font-semibold rounded transition-colors">
                                PDF
                            </a>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">40% contribution breakdown</p>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">60% contribution breakdown</p>
                    </div>
                </div>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Coming soon...</p>
            </div>
