...
@section('title', 'PPE – Lecturer Evaluation')
...
<div class="py-4 sm:py-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-4 sm:mb-6">
            <h1 class="text-xl sm:text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">PPE – Lecturer Evaluation</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
            <form method="GET" action="{{ route('academic.ppe.lecturer.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <!-- Search -->
                <div>
