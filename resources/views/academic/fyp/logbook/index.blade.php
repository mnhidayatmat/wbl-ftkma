...
@section('title', 'FYP Logbook Evaluation')
...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">FYP Logbook Evaluation</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Evaluate student progress logbook (Month 1-6)</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 mb-6">
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('academic.fyp.logbook.index') }}" 
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    <div class="w-24 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                        <div class="bg-[#0084C5] h-2 rounded-full transition-all" 
                                             style="width: {{ ($student->completed_months / 6) * 100 }}%"></div>
                                    </div>
                                    <span class="text-xs text-gray-600 dark:text-gray-400">{{ $student->completed_months }}/6</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-center">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('academic.fyp.logbook.show', $student) }}" 
