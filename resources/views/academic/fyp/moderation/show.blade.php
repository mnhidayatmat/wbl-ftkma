...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">AT Score</div>
                    <div class="text-2xl font-bold text-[#0084C5]">{{ number_format($atTotal + ($atRubricTotal ?? 0), 2) }}%</div>
                </div>
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <form method="POST" action="{{ route('academic.fyp.moderation.store', $student) }}" x-data="{ adjustmentType: '{{ $moderation->adjustment_type ?? 'percentage' }}' }">
                @csrf
                ...
                <div x-show="adjustmentType === 'manual_override'" class="mb-6 space-y-4">
                    <div>
                        ...
                        <input type="number" 
                               name="adjusted_at_score" 
                               value="{{ $moderation->adjusted_at_score ?? $finalScore }}"
                               step="0.01"
                               min="0"
