...
<div class="py-6 overflow-x-hidden">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">FYP Assessment Schedule</h1>
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-5">
                    ...
                    <form method="POST" action="{{ route('academic.fyp.schedule.update-window') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="notes" 
                                      rows="2"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#0084C5] focus:border-[#0084C5] dark:bg-gray-700 dark:text-white">{{ $atWindow->notes }}</textarea>
                        </div>
