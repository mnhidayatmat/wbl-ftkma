...
@section('title', 'FYP Assessment Schedule')
            ...
            <div class="bg-gradient-to-r from-[#003A6C] to-[#0084C5] rounded-2xl p-6 md:p-8">
                <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl md:text-3xl font-bold text-white">FYP Assessment Schedule</h1>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 p-5 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">AT Contribution</p>
                            </div>
                        </div>
                        ...
                        @elseif($atWindow->status === 'upcoming')
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span>{{ $atWindow->start_at->format('M d, Y') }} - {{ $atWindow->end_at->format('M d, Y') }}</span>
                    </div>
                    @else
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">IC Contribution</p>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/10 dark:to-gray-800 rounded-xl border border-purple-100 dark:border-purple-800/30 p-6">
                        <div class="flex items-center gap-3 mb-5">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ $atWindow->selected_assessments_display }}</p>
                            </div>
                        </div>

                        <form method="POST" action="{{ route('academic.fyp.schedule.update-window') }}" class="space-y-4">
                            @csrf
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="datetime-local"
                                           name="start_at"
                                           value="{{ $atWindow->start_at ? $atWindow->start_at->format('Y-m-d\TH:i') : '' }}"
                                           class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:text-white text-sm">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    ...
                                    <input type="datetime-local"
                                           name="end_at"
                                           value="{{ $atWindow->end_at ? $atWindow->end_at->format('Y-m-d\TH:i') : '' }}"
                                           class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:text-white text-sm">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="notes"
                                          ...
                                          class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:text-white text-sm">{{ $atWindow->notes }}</textarea>
                            </div>
                    ...
                    <div class="bg-gradient-to-br from-orange-50 to-white dark:from-orange-900/10 dark:to-gray-800 rounded-xl border border-orange-100 dark:border-orange-800/30 p-6">
                        <div class="flex items-center gap-3 mb-5">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ $icWindow->selected_assessments_display ?? 'All Assessments' }}</p>
                            </div>
                        </div>
