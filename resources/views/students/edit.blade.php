...
<div class="card-umpsa p-6">
    <form action="{{ route('admin.students.update', $student) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            <label class="block text-sm font-semibold text-umpsa-deep-blue dark:text-gray-300 mb-2">Student Photo</label>
            <div class="flex items-start gap-4">
                @if($student->image_path)
                    <div class="flex-shrink-0">
                        <img src="{{ asset('storage/' . $student->image_path) }}" alt="{{ $student->name }}" class="w-32 h-32 object-cover rounded-lg border-2 border-gray-300 dark:border-gray-600">
                    </div>
                @endif
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Upload a new photo (JPG, PNG, max 2MB). Leave empty to keep current photo.</p>
                    @error('image')
        ...
        <div class="mb-4">
            ...
            <select name="programme" id="programme" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('programme') border-red-500 @enderror" required>
                <option value="">Select a programme</option>
                @foreach($programmes as $programme)
                    <option value="{{ $programme->name }}" {{ old('programme', $student->programme) == $programme->name ? 'selected' : '' }}>{{ $programme->name }}</option>
                @endforeach
            </select>
            @error('programme')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="cgpa" id="cgpa" step="0.01" min="0" max="4" value="{{ old('cgpa', $student->cgpa) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('cgpa') border-red-500 @enderror">
            @error('cgpa')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="ic_number" id="ic_number" value="{{ old('ic_number', $student->ic_number) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('ic_number') border-red-500 @enderror" placeholder="e.g., 990101-01-1234">
            @error('ic_number')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="parent_name" id="parent_name" value="{{ old('parent_name', $student->parent_name) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('parent_name') border-red-500 @enderror" placeholder="e.g., Ahmad bin Abdullah">
            @error('parent_name')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="parent_phone_number" id="parent_phone_number" value="{{ old('parent_phone_number', $student->parent_phone_number) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('parent_phone_number') border-red-500 @enderror" placeholder="e.g., +60123456789">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="next_of_kin" id="next_of_kin" value="{{ old('next_of_kin', $student->next_of_kin) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('next_of_kin') border-red-500 @enderror" placeholder="e.g., Fatimah binti Ahmad (Sister)">
            @error('next_of_kin')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="next_of_kin_phone_number" id="next_of_kin_phone_number" value="{{ old('next_of_kin_phone_number', $student->next_of_kin_phone_number) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('next_of_kin_phone_number') border-red-500 @enderror" placeholder="e.g., +60123456789">
        ...
        <div class="mb-4">
            ...
            <div x-data="skillsInput({{ json_encode(old('skills', $student->skills ?? [])) }})">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="preferred_industry" id="preferred_industry" value="{{ old('preferred_industry', $student->preferred_industry) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-umpsa-teal focus:border-umpsa-teal @error('preferred_industry') border-red-500 @enderror" placeholder="e.g., Technology, Finance, Healthcare">
