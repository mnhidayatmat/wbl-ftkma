        ...
        <div class="w-full max-w-sm space-y-6">
            ...
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm" style="font-family: 'Inter', sans-serif;">
                    Join the WBL Management System and start your journey
                </p>
            </div>
            ...
            <form class="space-y-4" action="{{ route('register') }}" method="POST">
                ...
                <!-- Name Field -->
                <div>
                    <label for="name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2" style="font-family: 'Inter', sans-serif;">
                        Full Name
                    </label>
                    <input 
                        id="name" 
                ...
                <div>
                    ...
                    <div class="relative">
                        <input 
                            ...
                            required 
                            class="w-full px-4 py-3 pr-12 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 dark:bg-gray-800 dark:text-gray-100 transition-colors text-sm"
                ...
                <!-- Role Field -->
                <div>
                    <label for="role" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2" style="font-family: 'Inter', sans-serif;">
                        Role
                    </label>
                    <select 
                        id="role" 
                        name="role" 
                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-lg shadow-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-gray-900 dark:text-gray-100 transition-colors text-sm"
                        style="font-family: 'Inter', sans-serif;"
                    >
                ...
                <div class="text-center pt-2">
                    <p class="text-sm text-gray-600 dark:text-gray-400" style="font-family: 'Inter', sans-serif;">
                        ...
                        <a href="{{ route('login') }}" class="font-medium text-umpsa-teal hover:text-umpsa-royal-blue transition-colors">
                            Sign in
                        </a>
                    </p>
                </div>
