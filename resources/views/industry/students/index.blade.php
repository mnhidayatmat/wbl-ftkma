...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-10">
        <div class="mb-6">
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-2">Students assigned to you as Industry Coach</p>
        </div>

        <!-- Filters -->
        <div class="card-umpsa p-6 mb-6">
            <form method="GET" action="{{ route('industry.students.index') }}" class="flex flex-wrap gap-4">
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('industry.students.index') }}" class="ml-2 px-6 py-2 bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-lg transition-colors">
                        Clear
                    </a>
                </div>
            </form>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-[#003A6C]">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Academic Tutor</th>
                        ...
                        @forelse($students as $student)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('academic.ppe.ic.show', $student) }}" 
