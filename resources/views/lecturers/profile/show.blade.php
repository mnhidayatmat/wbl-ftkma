        ...
        <div class="flex items-center justify-between">
            <div>
                <nav class="text-sm text-gray-500 dark:text-gray-400 mb-1">
                    ...
                    <span class="text-gray-700 dark:text-gray-200">Lecturer</span>
                </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lecturer</p>

                    <!-- Role Badge -->
                    <div class="mt-4 inline-flex items-center px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200 text-sm font-medium">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('lecturer.profile.update') }}" class="p-6 space-y-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <a href="{{ route('dashboard') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                            Cancel
                        </a>
