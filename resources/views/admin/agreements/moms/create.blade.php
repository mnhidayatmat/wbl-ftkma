...
@section('title', 'Upload Minute of Meeting')
...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-slate-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    ...
    <div class="bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600 py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-white mb-1">Upload Minute of Meeting</h1>
                    <p class="text-purple-100">Link a single MoM to multiple companies</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('admin.agreements.moms.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="remarks" rows="2"
                                  ...
                                  class="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 dark:bg-gray-700 dark:text-white resize-none">{{ old('remarks') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                        ...
                        Upload MoM Document <span class="text-red-500">*</span>
                    </h2>
                </div>
                <div class="p-6">
                    <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-purple-400 transition-colors" id="dropZone">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">PDF only, maximum 10MB</p>
                            <input type="file" name="document" id="document" accept=".pdf" required class="hidden">
