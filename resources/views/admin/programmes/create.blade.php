...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">Add New Programme</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Create a new academic programme for students</p>
        </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                        <div>
                            ...
                            <input type="text" name="short_code" id="short_code" value="{{ old('short_code') }}" required maxlength="10"
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mt-2">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="wbl_coordinator_name" id="wbl_coordinator_name" value="{{ old('wbl_coordinator_name') }}"
                            ...
                            <div>
                                ...
                                <input type="email" name="wbl_coordinator_email" id="wbl_coordinator_email" value="{{ old('wbl_coordinator_email') }}"
                            ...
                            <div>
                                ...
                                <input type="tel" name="wbl_coordinator_phone" id="wbl_coordinator_phone" value="{{ old('wbl_coordinator_phone') }}" maxlength="20"
