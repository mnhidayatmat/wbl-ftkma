...
@section('title', 'SCL Word Template - Documents')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-2">
            <a href="{{ route('admin.documents.scl') }}" class="hover:text-purple-600 dark:hover:text-purple-400">Template SCL</a>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            </svg>
            <span>Word Template</span>
        </div>
        <h1 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5]">SCL Word Template</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Upload a Microsoft Word template for automatic SCL generation</p>
    </div>
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="flex flex-wrap gap-2 mt-4">
                    <a href="{{ route('admin.documents.scl.word-template.preview-docx') }}" target="_blank"
                       class="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg transition-colors text-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.documents.scl.word-template.download') }}"
                    ...
                    <form action="{{ route('admin.documents.scl.word-template.delete') }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this template?')">
                        @csrf
                        @method('DELETE')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-6">
        ...
        <form action="{{ route('admin.documents.scl.word-template.upload') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex items-center gap-4">
                <div class="flex-1">
                    ...
                    <label for="word_template_replace" class="flex items-center gap-3 px-4 py-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:border-purple-500 dark:hover:border-purple-400 transition-colors">
                ...
                <button type="submit" class="px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg transition-colors flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-purple-500 dark:hover:border-purple-400 transition-colors">
                ...
                <label for="word_template" class="cursor-pointer">
                    <div class="flex flex-col items-center gap-3">
                        ...
                        <p id="selectedFileName" class="text-sm text-purple-600 dark:text-purple-400 font-medium hidden"></p>
                    </div>
                </label>
            </div>

            <button type="submit" class="mt-4 w-full px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path>
                </svg>
                Upload Template
            ...
            <div>
                ...
                <div class="space-y-2 max-h-[400px] overflow-y-auto pr-2">
                    ...
                    <div class="flex items-center gap-2 py-2 px-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg group">
                        <code class="bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-2 py-0.5 rounded text-xs font-mono flex-shrink-0">{{ $variable }}</code>
                        <button type="button" onclick="copyVariable('{{ $variable }}')" class="p-1 text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors" title="Copy to clipboard">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
