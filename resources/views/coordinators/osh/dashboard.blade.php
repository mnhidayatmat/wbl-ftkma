...
<div class="mb-6">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold heading-umpsa">OSH Coordinator Dashboard</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Monitor and manage Occupational Safety & Health module</p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('academic.osh.reports.index') }}" class="px-4 py-2 bg-umpsa-primary hover:bg-umpsa-secondary text-white font-semibold rounded-lg transition-colors inline-flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('academic.osh.schedule.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
        ...
        <a href="{{ route('academic.osh.performance.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-4">
        ...
        <a href="{{ route('academic.osh.finalisation.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-4">
