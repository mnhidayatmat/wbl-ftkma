...
@section('title', 'Industrial Training Overview')
...
<div class="min-h-screen bg-umpsa-soft-gray dark:bg-gray-900 -mx-10 -my-6 px-10 py-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-[#003A6C] dark:text-[#0084C5]">Industrial Training Overview</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Latihan Industri - Semester 8</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            <div class="text-center py-12">
                ...
                <h2 class="text-2xl font-bold text-[#003A6C] dark:text-[#0084C5] mb-2">Industrial Training Module</h2>
                <p class="text-gray-600 dark:text-gray-400 mb-6">This module is currently under development.</p>
                <p class="text-sm text-gray-500 dark:text-gray-500">Your Industrial Training evaluations, progress logs, and marks will be displayed here.</p>
            </div>
        </div>
    </div>
</div>
