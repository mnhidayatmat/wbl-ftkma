...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-md p-5" x-data="{ open: false }">
        ...
        <div x-show="open" x-transition class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-4">
            <!-- STEP 1 -->
            <div class="border-l-4 border-[#0084C5] pl-4">
                <h4 class="text-md font-semibold text-[#003A6C] dark:text-[#0084C5] mb-2 flex items-center">
                    <span class="bg-[#0084C5] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-2">1</span>
                    Document Format
                </h4>
                <ul class="space-y-1 text-sm text-gray-700 dark:text-gray-300 ml-8">
                    <li class="flex items-start">
                        <svg class="w-4 h-4 text-green-600 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    ...
                    <li class="flex items-start">
                        <svg class="w-4 h-4 text-red-600 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
            ...
            <div class="border-l-4 border-[#0084C5] pl-4">
                <h4 class="text-md font-semibold text-[#003A6C] dark:text-[#0084C5] mb-2 flex items-center">
                    <span class="bg-[#0084C5] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-2">2</span>
                    Resume Guidelines (1–2 pages)
                </h4>
                <div class="ml-8 text-sm">
                    <p class="text-gray-700 dark:text-gray-300 font-medium mb-1">Must include:</p>
                    <ul class="space-y-0.5 text-gray-700 dark:text-gray-300 list-disc list-inside ml-2">
            ...
            <div class="border-l-4 border-[#0084C5] pl-4">
                <h4 class="text-md font-semibold text-[#003A6C] dark:text-[#0084C5] mb-2 flex items-center">
                    <span class="bg-[#0084C5] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-2">3</span>
                    Poster Portfolio (PD3, PD4, PD5)
                </h4>
                <div class="ml-8 text-sm">
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 p-2 rounded text-xs mb-2">
                        <p class="font-semibold text-yellow-800 dark:text-yellow-200">⚠️ POSTER projects only (not normal portfolio)</p>
                    </div>
                    <p class="text-gray-700 dark:text-gray-300 mb-1"><strong>Page limits:</strong> PD3 (1-2), PD4 (1-2), PD5 (1-2) = Max 6 pages total</p>
