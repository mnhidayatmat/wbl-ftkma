...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Upload example files for students (resume, poster, achievement)</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
            <form action="{{ route('reference-samples.store') }}"
                  method="POST"
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description"
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#0084C5] focus:border-[#0084C5] dark:bg-gray-700 dark:text-white"
                                  placeholder="Brief description of this reference sample...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="flex items-start">
                ...
                <div class="text-sm text-blue-700 dark:text-blue-300">
                    ...
                    <ul class="list-disc list-inside space-y-1 ml-2">
                        ...
                        <li>Active samples are immediately visible to students</li>
                    </ul>
                </div>
            </div>
        </div>
