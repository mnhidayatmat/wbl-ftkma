<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="relative overflow-hidden bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
            <div class="p-5">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex-shrink-0">
                        <div class="w-12 h-12 bg-[#0084C5]/10 dark:bg-[#0084C5]/20 rounded-lg flex items-center justify-center">
            ...
            <div class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#003A6C] to-[#0084C5]"></div>
        </div>
        ...
        <div class="relative overflow-hidden bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
            <div class="p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ $company->industryCoaches->count() }}</p>
                    </div>
                    <div class="flex-shrink-0">
                        <div class="w-12 h-12 bg-[#00AEEF]/10 dark:bg-[#00AEEF]/20 rounded-lg flex items-center justify-center">
            ...
            <div class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#0084C5] to-[#00AEEF]"></div>
        </div>
        ...
        <div class="relative overflow-hidden bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
            <div class="p-5">
                <div class="flex items-center justify-between">
                            ...
                            <div class="flex flex-wrap gap-1.5">
                                @php
                                    $typeColor = match($agreement->agreement_type) {
                                        'MoU' => 'bg-[#003A6C]/10 text-[#003A6C] dark:bg-[#003A6C]/30 dark:text-[#0084C5]',
                                        'MoA' => 'bg-[#0084C5]/10 text-[#0084C5] dark:bg-[#0084C5]/30 dark:text-[#00AEEF]',
                                        'LOI' => 'bg-[#00AEEF]/10 text-[#00AEEF] dark:bg-[#00AEEF]/30 dark:text-[#00AEEF]',
                    ...
                    <div class="flex-shrink-0">
                        <div class="w-12 h-12 bg-[#003A6C]/10 dark:bg-[#003A6C]/20 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-[#003A6C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="relative overflow-hidden bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
            ...
            <div class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#003A6C] to-[#00AEEF]"></div>
        </div>
    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                        ...
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0 w-10 h-10 bg-[#003A6C]/10 dark:bg-[#003A6C]/20 rounded-lg flex items-center justify-center">
                                <svg class="w-5 h-5 text-[#003A6C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1">
                                ...
                                <dd class="mt-1 text-base text-gray-900 dark:text-white">
                                    @if($company->category)
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-md text-sm font-medium bg-[#003A6C]/10 text-[#003A6C] dark:bg-[#003A6C]/30 dark:text-[#0084C5]">
                                            {{ $company->category }}
                                        </span>
                                    @else
                        ...
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0 w-10 h-10 bg-[#00AEEF]/10 dark:bg-[#00AEEF]/20 rounded-lg flex items-center justify-center">
                    ...
                    @if($primaryContact)
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="text-center">
                                ...
                                <span class="inline-flex items-center mt-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#0084C5]/10 text-[#0084C5] dark:bg-[#0084C5]/30 dark:text-[#00AEEF]">
                            ...
                            <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                <div class="flex-shrink-0 w-10 h-10 bg-[#0084C5]/10 dark:bg-[#0084C5]/30 rounded-lg flex items-center justify-center">
                                    <svg class="w-5 h-5 text-[#0084C5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                <div class="flex-shrink-0 w-10 h-10 bg-[#00AEEF]/10 dark:bg-[#00AEEF]/30 rounded-lg flex items-center justify-center">
                                    <svg class="w-5 h-5 text-[#00AEEF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-600">
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#0084C5] to-[#003A6C] rounded-full flex items-center justify-center">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <span class="inline-flex items-center mt-1 px-2 py-0.5 rounded-md text-xs font-medium bg-[#003A6C]/10 text-[#003A6C] dark:bg-[#003A6C]/30 dark:text-[#0084C5]">
                                {{ $contact->role }}
                            </span>
                        </div>
                    </div>
