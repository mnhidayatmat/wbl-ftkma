...
use App\Http\Controllers\Academic\PPE\PpeAssessmentSettingController;
...
use App\Http\Controllers\Academic\IP\IpProgressController;
    ...
    Route::prefix('academic/li')->name('academic.li.')->group(function () {
        ...
        Route::middleware('role:admin')->group(function () {
            ...
            Route::get('progress', function() {
                return view('academic.li.progress.index');
            })->name('progress.index');
            Route::get('moderation', function() {
                return view('academic.li.moderation.index');
            })->name('moderation.index');
            Route::get('finalisation', function() {
                return view('academic.li.finalisation.index');
            })->name('finalisation.index');
            Route::get('reports', function() {
                return view('academic.li.reports.index');
            })->name('reports.index');
