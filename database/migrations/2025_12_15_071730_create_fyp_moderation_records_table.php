...
return new class extends Migration
{
    ...
    {
        Schema::create('fyp_moderation_records', function (Blueprint $table) {
            $table->id();
            $table->foreignId('student_id')->constrained('students')->onDelete('cascade');
            $table->decimal('original_at_score', 5, 2)->nullable();
            $table->decimal('original_final_score', 5, 2)->nullable();
            $table->decimal('adjusted_at_score', 5, 2)->nullable();
    ...
    {
        Schema::dropIfExists('fyp_moderation_records');
    }
};
