...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fyp_assessment_window_assessments', function (Blueprint $table) {
            $table->id();
            $table->foreignId('fyp_assessment_window_id')
                ->constrained('fyp_assessment_windows')
                ->onDelete('cascade');
            ...
            $table->unique(['fyp_assessment_window_id', 'assessment_id'], 'fyp_aw_assessment_unique');
        });
    }
